...
<form method="post" action="editar_perfil.php?id=<?php echo $id; ?>">
    ...
    <label style="color: black;" for="cartao">Cartão:</label>
    <select id="cartao" name="cartao">
        <option style="color: black;" value="débito" <?php if ($usuario['cartao'] == 'débito') echo 'selected'; ?>>Débito</option>
        <option style="color: black;" value="crédito" <?php if ($usuario['cartao'] == 'crédito') echo 'selected'; ?>>Crédito</option>
    </select><br><br>
    <label style="color: black;" for="conhecimento">Conhecimento:</label>
    <select id="conhecimento" name="conhecimento">
        <option style="color: black;" value="básico" <?php if ($usuario['conhecimento'] == 'básico') echo 'selected'; ?>>Básico</option>
        <option style="color: black;" value="médio" <?php if ($usuario['conhecimento'] == 'médio') echo 'selected'; ?>>Médio</option>
        <option style="color: black;" value="avançado" <?php if ($usuario['conhecimento'] == 'avançado') echo 'selected'; ?>>Avançado</option>
    </select><br><br>
    <label style="color: black;" for="renda_mensal">Renda Mensal:</label>
    ...
    <label style="color: black;" for="valor_final">Valor que sobra no Final do mês:</label>
    ...
    <input style="color: black;" type="submit" value="Salvar">
</form>
